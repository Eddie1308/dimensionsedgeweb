          ...
          <div className="lg:col-span-4">
            ...
            <ul className="mt-6 space-y-3 text-sm">
              <li className="flex items-start gap-3">
                ...
                <a href="mailto:info@dimensionsedge.sa" className="hover:text-white">
...
function FooterLink({
  ...
  return (
    <li>
      <Link
        href={href}
        className="text-[var(--color-brand-200)] transition-colors hover:text-white"
      >
        {children}
      </Link>
    </li>
